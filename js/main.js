  ...
  try {
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      for (let i = 0; i < values.length; ++i) {
        ...
        if (el.type === "checkbox") el.setAttribute("checked", "checked");else el.value = values[i][1];
      }
    });
  } catch (err) {
    console.log(err);
...
$(function () {
      ...
      function init() {
        ...
        ymaps.geocode([53.430367, 59.081055]).then(function (res) {
          ...
          var myPlacemark = new ymaps.Placemark(coord, {
            ...
            balloonContentBody: '<div class="balloon">' + '<div class="balloon__bloc"><div class="balloon__header">Адрес</div><div class="balloon__text">г. Магнитогорск, ул. Электросети, д. 38 </div></div>' + '<div class="balloon__bloc"><div class="balloon__header">Телефон</div><a href="tel:8(800)562-58-58" class="balloon__text">8 (800) 562-58-58</a></div>' + '<div class="balloon__bloc"><div class="balloon__header">График работы</div><div class="balloon__text">Пн - Пт | 9:00 - 19:00, Сб - Вс | 10:00 - 18:00</div></div>' + '<div>',
  ...
  function disableScroll() {
    ...
    scrollLeft = window.pageXOffset || document.documentElement.scrollLeft, // if any scroll is attempted, 
